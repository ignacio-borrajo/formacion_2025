...
class Category(models.Model):
    ...
    def get_default_pk(cls):
        category, create = cls.objects.get_or_create(
            name="Base", description="Falta Categoria por defecto"
        )
...
class Expense(models.Model):
    ...
    category = models.ForeignKey(
        Category, on_delete=models.CASCADE, default=Category.get_default_pk
    )
    ...
    user = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="expenses",  # Como referirse a expenses desde users, para la relacion inversa
